...
void anchor::parsimPack(cCommBuffer *b)
{
    doPacking(b,this->positionOfPreviousForwarder_var);
    doPacking(b,this->positionOfCurrentNode_var);
    doPacking(b,this->speedOfPreviousForwarder_var);
    doPacking(b,this->speedOfCurrentNode_var);
    doPacking(b,this->position_var);
}

void anchor::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,this->positionOfPreviousForwarder_var);
    doUnpacking(b,this->positionOfCurrentNode_var);
    doUnpacking(b,this->speedOfPreviousForwarder_var);
    doUnpacking(b,this->speedOfCurrentNode_var);
    doUnpacking(b,this->position_var);
}
...
class anchorDescriptor : public cClassDescriptor
{
  public:
    anchorDescriptor();
    virtual ~anchorDescriptor();
...
Register_ClassDescriptor(anchorDescriptor);

anchorDescriptor::anchorDescriptor() : cClassDescriptor("anchor", "cObject")
{
}
...
bool anchorDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<anchor *>(obj)!=NULL;
}

const char *anchorDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int anchorDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 5+basedesc->getFieldCount(object) : 5;
}

unsigned int anchorDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *anchorDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    static const char *fieldNames[] = {
        "positionOfPreviousForwarder",
        "positionOfCurrentNode",
        "speedOfPreviousForwarder",
        "speedOfCurrentNode",
        "position",
    };
...
int anchorDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='p' && strcmp(fieldName, "positionOfPreviousForwarder")==0) return base+0;
    if (fieldName[0]=='p' && strcmp(fieldName, "positionOfCurrentNode")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "speedOfPreviousForwarder")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "speedOfCurrentNode")==0) return base+3;
    if (fieldName[0]=='p' && strcmp(fieldName, "position")==0) return base+4;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *anchorDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *anchorDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int anchorDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    anchor *pp = (anchor *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string anchorDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    anchor *pp = (anchor *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getPositionOfPreviousForwarder(); return out.str();}
        case 1: {std::stringstream out; out << pp->getPositionOfCurrentNode(); return out.str();}
        case 2: {std::stringstream out; out << pp->getSpeedOfPreviousForwarder(); return out.str();}
        case 3: {std::stringstream out; out << pp->getSpeedOfCurrentNode(); return out.str();}
        case 4: {std::stringstream out; out << pp->getPosition(); return out.str();}
        default: return "";
    }
}

bool anchorDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *anchorDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *anchorDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    anchor *pp = (anchor *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getPositionOfPreviousForwarder()); break;
        case 1: return (void *)(&pp->getPositionOfCurrentNode()); break;
        case 2: return (void *)(&pp->getSpeedOfPreviousForwarder()); break;
        case 3: return (void *)(&pp->getSpeedOfCurrentNode()); break;
        case 4: return (void *)(&pp->getPosition()); break;
        default: return NULL;
    }
}
...
IPvXAddress& carPacket::getSenderAddress()
{
    return senderAddress_var;
}

void carPacket::setSenderAddress(const IPvXAddress& senderAddress)
{
    this->senderAddress_var = senderAddress;
}

anchor& carPacket::getAnchor()
{
    return Anchor_var;
}

void carPacket::setAnchor(const anchor& Anchor)
{
...
const char *carPacketDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 3: return opp_typename(typeid(anchor));
        default: return NULL;
    };
}
...
void *carPacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)static_cast<cObject *>(&pp->getAnchor()); break;
        default: return NULL;
    }
}
